...
(function(root, factory) {
	...
	function photoClip(container, option) {
		...
		function clipImg() {
			...
			console.log(curX,local.x);
			console.log(curY,local.y);
			$('#ceshi').html("scale:"+scale+" curAngle:"+curAngle+" canvas.width:"+canvas.width+" canvas.height:"+canvas.height+" curX:"+curX+" local.x:"+local.x+" curY:"+curY+" local.y:"+local.y)
